...
CREATE INDEX idx_reviews_order_score   ON order_reviews(order_id, review_score);
CREATE INDEX idx_op_type_covering      ON order_payments(payment_type, order_id, payment_installments, payment_value);
